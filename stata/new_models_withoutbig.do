...
import delimited df_reduced.csv

* Start logging

log using scvs_log_reduced.log, replace
...
outreg2 [m*] using "OutputReduced", excel replace addstat (Adj. R^2, e(r2_a))keep(did period vax_leastone vax_complete excessd year m_retail m_grocery m_parks m_transit m_residential m_workplace total_cases case_rate new_cases new_case_rate excessd_rate)
...
outreg2 [error*] using "OutputErrorReduced", excel replace addstat (Adj. R^2, e(r2_a))
 * Turn off the log
log close 
* Exit
exit
